...
1. **Place Model Weights**:
   ...
   The algorithm service uses notebook-style preprocessing: 112x112 RGB frames, motion-difference channels, a 16-frame window, and a smoothed alert score before publishing.
